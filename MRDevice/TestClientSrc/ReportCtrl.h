...
//	BOOL SetItemText(int nItem, int nSubItem, USHORT val); // Unsigned short.
	...
	void SetItemTextColor(int nItem, COLORREF clrText);
	void SetSubItemTextColor(int nItem, int nSubItem, COLORREF clrText);
	void SetItemBkColor(int nItem, COLORREF clrBk);
	COLORREF GetItemTextColor(int nItem);
	COLORREF GetSubItemTextColor(int nItem, int nSubItem);
	COLORREF GetItemBkColor(int nItem);
	void ClearItemColor(int nItem);
...
protected:
	...
	static BOOL _IsHeadNumber(LPCTSTR pszText);
