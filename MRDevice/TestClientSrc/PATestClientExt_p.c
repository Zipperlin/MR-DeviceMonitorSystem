...
#define TYPE_FORMAT_STRING_SIZE   773                               
...
/* Standard interface: __MIDL_itf_PATestClientExt_0000, ver. 0.0,
...
const CInterfaceProxyVtbl * _PATestClientExt_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _PATestClientExt_StubVtblList[] = 
{
...
PCInterfaceName const _PATestClientExt_InterfaceNamesList[] = 
{
    "IDBPIM",
    "IDBSession",
    "IDBConfig",
...
#define _PATestClientExt_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PATestClientExt, pIID, n)

int __stdcall _PATestClientExt_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _PATestClientExt, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _PATestClientExt, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _PATestClientExt, 3, *pIndex )
    
}

const ExtendedProxyFileInfo PATestClientExt_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PATestClientExt_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PATestClientExt_StubVtblList,
    (const PCInterfaceName * ) & _PATestClientExt_InterfaceNamesList,
    0, // no delegation
    & _PATestClientExt_IID_Lookup, 
    3,
    2,
