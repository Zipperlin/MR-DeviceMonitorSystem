/* Time: <@(#)ado.h   2009-3-26 - 15:29:58   Fan Zengfei >
 *********************************************************************
 ...
 * $Log: $ 
 *
 *	1	2009-3-26 - 15:29:58		FanZF	Creation
 *
 *********************************************************************
 */
...
#include "icrsint.h"
#include "Afxmt.h"//added by SongWei
...
protected:
	...
	CString m_strQuery;
	CCriticalSection	m_ADOLock;//added by SongWei
